...
- 21774e6: Accept the constraints the emulated camera advertises it supports.
...
- 3d42a70: Remove a duplicated README section that documented a `forceReadyState` option the library does not have.
